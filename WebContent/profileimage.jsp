...
<ul id="navigation">
				...
				<li style="font-size:18px;color:blue;padding-left:50px;">
					<i>Welcome, <%= membername%></i>
				</li>
			</ul>
			
</div>
<form name="second" class="snform" id="profileimage-form" action="upimg.jsp?meid=<%=memberid %>" enctype="multipart/form-data" method="post">
...
<input type="hidden" id="meid" name="meid" value=<%=memberid %> readonly>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Browse image file&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" name="profileimage" id="profileimage"></input>
<br/>
<br/>
<div align="center">
...
<br />
<br />
<div style="padding-right:80px;font-size:30px;"align="right">
<a href="userhome.jsp?labels=recentpost&words=occur&res=noth"><i>Skip</i></a>
</div>
