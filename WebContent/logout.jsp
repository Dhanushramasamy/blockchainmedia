...
<%
     ...
     String membername1=(String)session.getAttribute("Membername");
	String memberid1=(String)session.getAttribute("Memberid");
	String memberemail1=(String)session.getAttribute("Memberemail");
    if(membername1!=null)
        {
	        ...
	        int i1y1=st.executeUpdate("update chatingmember set status='offline' where memberid='"+memberid1+"'");
