...
<body>
<%
String maild=request.getParameter("emailid1");
String usern=request.getParameter("usern1");
String skey=request.getParameter("skey1");

String maild1=request.getParameter("emailid");
String usern1=request.getParameter("usern");
String skey1=request.getParameter("skey");
...
try {
	...
	message.setFrom(new InternetAddress(username));
		  ...
		  new InternetAddress(%><%request.getParameter("emailid1")%><%)
		  };
...
response.sendRedirect("userhome.jsp?labels=requestedfriends&sekey=send");
%>
</body>
</html>